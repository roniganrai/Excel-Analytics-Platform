...
const NavbarMain = ({ onToggleDrawer }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-6 py-4 bg-black/80 border-b border-white/20 shadow-md backdrop-blur-md">
      {/* ☰ Sidebar Toggle + Logo */}
